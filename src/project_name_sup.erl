...
init([]) ->
    ...
    Dispatch =
        cowboy_router:compile([
                              ...
                              {'_', [
                                    {"/", cowboy_static, {priv_file, project_name, "index.html"}}
                                    ,{"/js/[...]", cowboy_static, {priv_dir, project_name, "./js"}}
                                    ,{"/css/[...]", cowboy_static, {priv_dir, project_name, "./css"}}
                                    ,{'_', project_name_handler, []}
                                    ]}
                              ]),
